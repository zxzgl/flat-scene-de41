...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/flat-scene-de41)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/flat-scene-de41
```

A live public deployment of this template is available at [https://flat-scene-de41.templates.workers.dev](https://flat-scene-de41.templates.workers.dev)
